## Title
Stored Cross-Site Scripting (XSS) in "name" field

## Summary
I found a Stored Cross-Site Scripting vulnerability in the "name" field in following url
...
## Steps to Reproduce
1. Open the following URL in a browser: http://kzlabs.com/51.php
2. Enter following payload sk404"><script>alert(1)</script> in name field 
...
<img width="3000" height="1034" alt="image" src="https://github.com/user-attachments/assets/c56f72c6-c1fb-48ba-9c23-0fbfdbef3388" />

<img width="3000" height="802" alt="image" src="https://github.com/user-attachments/assets/91819c19-8c00-459f-be15-f1a89bea43b3" />
